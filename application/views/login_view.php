...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
  ...
  <div class="login-box">
    ...
    <div class="login-logo">
      <a href="index.php" style="color: yellow;">Rumah Pintar Pemilu<br /><b>KPU Kota Blitar</b></a>
    </div>
    ...
    <footer>
      <div class="login-box-body text-center bg-blue">
        <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan KPU - <?php echo date("Y"); ?>
      </div>
    </footer>
  </div>
  <!-- /.login-box -->
