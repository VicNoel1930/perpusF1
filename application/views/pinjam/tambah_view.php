											...
											<?php } else { ?>
												<td>
													...
													<div class="input-group" style="width: 100%;">
														<input type="text" class="form-control" readonly autocomplete="off" name="anggota_id" placeholder="Contoh ID Anggota : AG001" type="text" value="<?php echo $d->anggota_id; ?>">
													</div>
												</td>
											<?php } ?>
										</tr>
